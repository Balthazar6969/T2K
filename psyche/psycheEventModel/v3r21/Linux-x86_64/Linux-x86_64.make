...
BIN=/mnt/data/backup/home/cfrancois/T2K2/psyche/psycheEventModel/v3r21/$(psycheEventModel_tag)/
javabin=../classes/
mgrdir=cmt
project=cfrancois
...
use_includes= $(ppcmd)"$(psycheCore_root)/src" $(ppcmd)"$(psychePolicy_root)/src" $(ppcmd)"/mnt/data/T2K/frozen/ROOT/v5r34p09n04/Linux-x86_64/include/root" $(ppcmd)"none" $(ppcmd)"/mnt/data/T2K/frozen/MYSQL/v5r051an01/Linux-x86_64/include/mysql" $(ppcmd)"/mnt/data/T2K/frozen/GSL/v1r15p0n00/Linux-x86_64/include" $(ppcmd)"$(EXTERN_root)/src" 
