...
#  Library psycheCore
#
#   Generated Mon Nov  4 15:26:36 2019  by cfrancois
#
#====================================
...
$(psycheCorelib) :: $(bin)CoreDataClasses.o $(bin)UnitsParser.o $(bin)CoreUtils.o $(bin)DataSample.o $(bin)WeightType.o $(bin)SystematicCovariance.o $(bin)EventVariationBase.o $(bin)EventVariationManager.o $(bin)SystematicManager.o $(bin)EventWeightBase.o $(bin)EventWeightManager.o $(bin)TreeManager.o $(bin)Experiment.o $(bin)HEPConstants.o $(bin)HLClonesArray.o $(bin)ToyBoxB.o $(bin)Header.o $(bin)InputConverter.o $(bin)InputManager.o $(bin)Parameters.o $(bin)ParticleId.o $(bin)SelectionBase.o $(bin)SelectionManager.o $(bin)StepBase.o $(bin)SystBoxB.o $(bin)SystematicBase.o $(bin)ToyExperiment.o $(bin)ToyMaker.o $(bin)ToyVariations.o $(bin)TreeManager_Dict.o $(bin)CoreDataClasses_Dict.o $(bin)DataSample_Dict.o $(bin)SystematicBase_Dict.o $(bin)Experiment_Dict.o $(bin)HLClonesArray_Dict.o $(bin)Header_Dict.o $(bin)SelectionBase_Dict.o $(bin)StepBase_Dict.o
...
psycheCoreclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)CoreDataClasses.o $(bin)UnitsParser.o $(bin)CoreUtils.o $(bin)DataSample.o $(bin)WeightType.o $(bin)SystematicCovariance.o $(bin)EventVariationBase.o $(bin)EventVariationManager.o $(bin)SystematicManager.o $(bin)EventWeightBase.o $(bin)EventWeightManager.o $(bin)TreeManager.o $(bin)Experiment.o $(bin)HEPConstants.o $(bin)HLClonesArray.o $(bin)ToyBoxB.o $(bin)Header.o $(bin)InputConverter.o $(bin)InputManager.o $(bin)Parameters.o $(bin)ParticleId.o $(bin)SelectionBase.o $(bin)SelectionManager.o $(bin)StepBase.o $(bin)SystBoxB.o $(bin)SystematicBase.o $(bin)ToyExperiment.o $(bin)ToyMaker.o $(bin)ToyVariations.o $(bin)TreeManager_Dict.o $(bin)CoreDataClasses_Dict.o $(bin)DataSample_Dict.o $(bin)SystematicBase_Dict.o $(bin)Experiment_Dict.o $(bin)HLClonesArray_Dict.o $(bin)Header_Dict.o $(bin)SelectionBase_Dict.o $(bin)StepBase_Dict.o
...
ifndef QUICK
$(bin)psycheCore_dependencies.make : ../src/CoreDataClasses.cxx ../src/UnitsParser.cxx ../src/CoreUtils.cxx ../src/DataSample.cxx ../src/WeightType.cxx ../src/SystematicCovariance.cxx ../src/EventVariationBase.cxx ../src/EventVariationManager.cxx ../src/SystematicManager.cxx ../src/EventWeightBase.cxx ../src/EventWeightManager.cxx ../src/TreeManager.cxx ../src/Experiment.cxx ../src/HEPConstants.cxx ../src/HLClonesArray.cxx ../src/ToyBoxB.cxx ../src/Header.cxx ../src/InputConverter.cxx ../src/InputManager.cxx ../src/Parameters.cxx ../src/ParticleId.cxx ../src/SelectionBase.cxx ../src/SelectionManager.cxx ../src/StepBase.cxx ../src/SystBoxB.cxx ../src/SystematicBase.cxx ../src/ToyExperiment.cxx ../src/ToyMaker.cxx ../src/ToyVariations.cxx ../dict/TreeManager_Dict.cxx ../dict/CoreDataClasses_Dict.cxx ../dict/DataSample_Dict.cxx ../dict/SystematicBase_Dict.cxx ../dict/Experiment_Dict.cxx ../dict/HLClonesArray_Dict.cxx ../dict/Header_Dict.cxx ../dict/SelectionBase_Dict.cxx ../dict/StepBase_Dict.cxx $(use_requirements) $(cmt_final_setup_psycheCore)
	$(echo) "(psycheCore.make) Rebuilding $@"; \
	  $(build_dependencies) psycheCore -all_sources -out=$@ ../src/CoreDataClasses.cxx ../src/UnitsParser.cxx ../src/CoreUtils.cxx ../src/DataSample.cxx ../src/WeightType.cxx ../src/SystematicCovariance.cxx ../src/EventVariationBase.cxx ../src/EventVariationManager.cxx ../src/SystematicManager.cxx ../src/EventWeightBase.cxx ../src/EventWeightManager.cxx ../src/TreeManager.cxx ../src/Experiment.cxx ../src/HEPConstants.cxx ../src/HLClonesArray.cxx ../src/ToyBoxB.cxx ../src/Header.cxx ../src/InputConverter.cxx ../src/InputManager.cxx ../src/Parameters.cxx ../src/ParticleId.cxx ../src/SelectionBase.cxx ../src/SelectionManager.cxx ../src/StepBase.cxx ../src/SystBoxB.cxx ../src/SystematicBase.cxx ../src/ToyExperiment.cxx ../src/ToyMaker.cxx ../src/ToyVariations.cxx ../dict/TreeManager_Dict.cxx ../dict/CoreDataClasses_Dict.cxx ../dict/DataSample_Dict.cxx ../dict/SystematicBase_Dict.cxx ../dict/Experiment_Dict.cxx ../dict/HLClonesArray_Dict.cxx ../dict/Header_Dict.cxx ../dict/SelectionBase_Dict.cxx ../dict/StepBase_Dict.cxx
endif
