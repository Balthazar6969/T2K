{
  ...
  // Fwd: selmu_fgdlayer
  // -------------------------------------------------
  TCanvas *Fwd_selmu_fgdlayer = new TCanvas("Fwd_selmu_fgdlayer","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.22,0.90,0.40,0.91);
    draw.SetTitleX("#mu candidate start FGD1 layer [-]");
    draw.SetTitleY("#events");
    draw.SetMaxY(12000);
    draw.Draw(exp,"selmu_fgdlayer",34,-1.5,32.5,"reactionCC","accum_level[0][0]>5","E1","POTNORM",-1,true); //"","NODATA",-1 //E1 is the argument for root: Plotting error bars with small lines at the end
    //draw.DrawCutLineVertical(1.5,true,"l");
    draw.DrawCutLineVertical(27.5,true,"l");
    Fwd_selmu_fgdlayer->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_fgdlayer.png");

  // -------------------------------------------------
  // Fwd: selmu_ToF_FGD1_to_earliestECal
  // -------------------------------------------------
  TCanvas *Fwd_ToF_FGD1_to_earliestECal = new TCanvas("Fwd_ToF_FGD1_to_earliestECal","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.22,0.90,0.40,0.91);
    draw.SetTitleX("#mu candidate ToF FGD1-earliestECal [ns]");
    draw.SetTitleY("#events");
    draw.SetMaxY();
    draw.Draw(exp,"selmu_ToF_ecal_fgd1_other",80,-20,20,"reactionCC","accum_level[0][0]>6","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(1.20,true,"r");
    Fwd_ToF_FGD1_to_earliestECal->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_ToF_FGD1_to_earliestECal.png");


  // -------------------------------------------------
  // Fwd: ToF from FGD1 to: TECal
  // -------------------------------------------------
  // TCanvas *Fwd_ToF_FGD1_to_TECal = new TCanvas("Fwd_ToF_FGD1_to_TECal","Canvas",npix_x,npix_y);
  //   gStyle->SetOptStat(0);
  //   draw.SetMinY(0);
  //   draw.SetLogY(0);
  //   draw.SetLegendParam(0.22,0.90,0.40,0.91);
  ...
  //   draw.SetTitleY("#events");
  //   draw.Draw(exp,"selmu_ToF_tecal_fgd1",80,-40,40,"reactionCC","accum_level[][0]>7","E1","POTNORM",-1,true);
  //   draw.DrawCutLineVertical(0.4,true,"r");
  //   Fwd_ToF_FGD1_to_TECal->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_ToF_FGD1_to_TECal.png");

  // -------------------------------------------------
  // Fwd: selmu_ToF_FGD1_to_FGD2
  // -------------------------------------------------
  //TCanvas *Fwd_ToF_FGD1_to_FGD2 = new TCanvas("Fwd_ToF_FGD1_to_FGD2","Canvas",npix_x,npix_y);
  //  gStyle->SetOptStat(0);
  //  draw.SetLegendParam(0.22,0.92,0.40,0.92);
  //  draw.SetTitleX("#mu candidate ToF FGD1-FGD2 [ns]");
  //  draw.SetTitleY("#events");
  //  draw.Draw(exp,"selmu_ToF_fgd1_fgd2",100,-20,20,"reactionCC","accum_level[0][0]>7","E1","POTNORM",-1,true);
  //  Fwd_ToF_FGD1_to_FGD2->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_ToF_FGD1_to_FGD2.png");


  // -------------------------------------------------
  // Fwd: selmu_mom of ECal contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_mom_ecal_contained1 = new TCanvas("Fwd_selmu_mom_ecal_contained1","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    draw.SetTitleY("#events");
    draw.SetMaxY();
    draw.Draw(exp,"selmu_mom",100,0,3000,"particle","accum_level[0][0]>7 && selmu_ecal_containment==1","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(745,true,"l");
    Fwd_selmu_mom_ecal_contained1->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_ECal_contained.png");

  // -------------------------------------------------
  // Fwd: selmu_mom of ECal NOT contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_mom_ecal_not_contained = new TCanvas("Fwd_selmu_mom_ecal_not_contained","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    draw.SetTitleY("#events");
    draw.SetMaxY();
    draw.Draw(exp,"selmu_mom",100,0,3000,"particle","accum_level[0][0]>7 && selmu_ecal_containment==0","E1","POTNORM",-1,true);
    Fwd_selmu_mom_ecal_not_contained->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_ECal_not_contained.png");

  // -------------------------------------------------
  // Fwd: selmu_truemom of ECal contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_truemom_ecal_contained = new TCanvas("Fwd_selmu_truemom_ecal_contained","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("true momentum [MeV/c]");
    draw.SetTitleY("#events");
    draw.SetMaxY();
    draw.Draw(exp,"selmu_truemom",100,0,3000,"particle","accum_level[0][0]>7 && selmu_ecal_containment==1","E1","POTNORM",-1,true);
    Fwd_selmu_truemom_ecal_contained->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_truemom_ECal_contained.png");

  // -------------------------------------------------
  // Fwd: selmu_truemom of ECal NOT contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_truemom_ecal_not_contained = new TCanvas("Fwd_selmu_truemom_ecal_not_contained","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("true momentum [MeV/c]");
    draw.SetTitleY("#events");
    draw.SetMaxY();
    draw.Draw(exp,"selmu_truemom",100,0,3000,"particle","accum_level[0][0]>7 && selmu_ecal_containment==0","E1","POTNORM",-1,true);
    Fwd_selmu_truemom_ecal_not_contained->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_truemom_ECal_not_contained.png");

  // -------------------------------------------------
  // Fwd: selmu_ecal_mippion for ECal contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_ecal_mippion_contained = new TCanvas("Fwd_selmu_ecal_mippion_contained","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.22,0.90,0.40,0.91);
    ...
    draw.SetLogY(1);
    draw.SetMaxY();
    draw.Draw(exp,"selmu_ecal_mippion",65,-60,70,"particle","accum_level[0][0]>7 && selmu_ecal_containment==1","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(16.0,true,"l");
    Fwd_selmu_ecal_mippion_contained->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_ecal_mippion_contained.png");

  // -------------------------------------------------
  // Fwd: selmu_ecal_mippion for ECal NOT contained tracks
  // -------------------------------------------------
  TCanvas *Fwd_selmu_ecal_mippion_not_contained = new TCanvas("Fwd_selmu_ecal_mippion_not_contained","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.22,0.90,0.40,0.91);
    draw.SetTitleX("#mu candidate ECal MIPPion [-]");
    draw.SetTitleY("#events");
    ...
    draw.SetLogY(1);
    draw.SetMaxY();
    draw.Draw(exp,"selmu_ecal_mippion",65,-60,70,"particle","accum_level[0][0]>8 && selmu_ecal_containment==0","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(17.4,true,"l");
    Fwd_selmu_ecal_mippion_not_contained->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_ecal_mippion_not_contained.png");



  // -------------------------------------------------
  // Fwd: selmu_mom for tracks stopping in FGD2
  // -------------------------------------------------
  TCanvas *Fwd_selmu_mom_stopping_in_FGD2_0 = new TCanvas("Fwd_selmu_mom_stopping_in_FGD2_0","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    draw.SetTitleY("#events");
    ...
    draw.SetLogY(0);
    draw.SetMaxY(3400);
    draw.Draw(exp,"selmu_mom",100,0,3000,"particle","accum_level[0][0]>9","E1","POTNORM",-1,true);
    Fwd_selmu_mom_stopping_in_FGD2_0->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_stopping_in_FGD2_before_Cut_linear.png");

  TCanvas *Fwd_selmu_mom_stopping_in_FGD2_1 = new TCanvas("Fwd_selmu_mom_stopping_in_FGD2_1","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    draw.SetTitleY("#events");
    ...
    draw.SetLogY(0);
    draw.SetMaxY(3400);
    draw.Draw(exp,"selmu_mom",100,0,3000,"particle","accum_level[0][0]>10","E1","POTNORM",-1,true);
    Fwd_selmu_mom_stopping_in_FGD2_1->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_stopping_in_FGD2_after_Cut_linear.png");

  TCanvas *Fwd_selmu_mom_stopping_in_FGD2_2 = new TCanvas("Fwd_selmu_mom_stopping_in_FGD2_2","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    draw.SetTitleY("#events");
    ...
    draw.SetLogY(0);
    draw.SetMaxY();
    draw.Draw(exp,"selmu_mom",60,0,3000,"particle","accum_level[0][0]==10","E1","POTNORM",-1,true);
    Fwd_selmu_mom_stopping_in_FGD2_2->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_stopping_in_FGD2_failed_Cut_linear.png");

  TCanvas *Fwd_selmu_mom_stopping_in_FGD2_3 = new TCanvas("Fwd_selmu_mom_stopping_in_FGD2_3","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    gStyle->SetTitleOffset(1.3,"Y");
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("stopping in FGD2 [-]");
    draw.SetTitleY("#events");
    draw.SetMinY(0);
    draw.SetLogY(0);
    draw.SetMaxY();
    draw.Draw(exp,"!cut10[0][0]",2,-0.5,1.5,"particle","accum_level[0][0]>9","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(0.5,true,"l");
    Fwd_selmu_mom_stopping_in_FGD2_3->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_stopping_in_FGD2.png");


  // -------------------------------------------------
  // Fwd: selmu_mom for tracks with P0D veto
  // -------------------------------------------------
  TCanvas *Fwd_selmu_mom_P0Dveto_0 = new TCanvas("Fwd_selmu_mom_P0Dveto_0","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    gStyle->SetTitleOffset(1.3,"Y");
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    ...
    draw.SetLogY(0);
    draw.SetMaxY(3100);
    draw.Draw(exp,"selmu_mom",100,0,3000,"reactionCC","accum_level[0][0]>10","E1","POTNORM",-1,true);
    //draw.DrawCutLineVertical(0.5,true,"l");
    Fwd_selmu_mom_P0Dveto_0->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_before_P0Dveto.png");

  TCanvas *Fwd_selmu_mom_P0Dveto_1 = new TCanvas("Fwd_selmu_mom_P0Dveto_1","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    gStyle->SetTitleOffset(1.3,"Y");
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    ...
    draw.SetLogY(0);
    draw.SetMaxY(3100);
    draw.Draw(exp,"selmu_mom",100,0,3000,"reactionCC","accum_level[0][0]>11","E1","POTNORM",-1,true);
    //draw.DrawCutLineVertical(0.5,true,"l");
    Fwd_selmu_mom_P0Dveto_1->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_after_P0Dveto.png");

  TCanvas *Fwd_selmu_mom_P0Dveto_2 = new TCanvas("Fwd_selmu_mom_P0Dveto_2","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    gStyle->SetTitleOffset(1.3,"Y");
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("reconstructed momentum [MeV/c]");
    ...
    draw.SetLogY(0);
    draw.SetMaxY();
    draw.Draw(exp,"selmu_mom",60,0,3000,"reactionCC","accum_level[0][0]==11","E1","POTNORM",-1,true);
    //draw.DrawCutLineVertical(0.5,true,"l");
    Fwd_selmu_mom_P0Dveto_2->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_failed_P0Dveto.png");

  TCanvas *Fwd_selmu_mom_P0Dveto_3 = new TCanvas("Fwd_selmu_mom_P0Dveto_3","Canvas",npix_x,npix_y);
    gStyle->SetOptStat(0);
    gStyle->SetTitleOffset(1.3,"Y");
    draw.SetLegendParam(0.72,0.90,0.90,0.91);
    draw.SetTitleX("P0D veto [-]");
    draw.SetTitleY("#events");
    draw.SetMinY(0);
    draw.SetLogY(0);
    draw.SetMaxY();
    draw.Draw(exp,"!cut11[0][0]",2,-0.5,1.5,"reactionCC","accum_level[0][0]>10","E1","POTNORM",-1,true);
    draw.DrawCutLineVertical(0.5,true,"l");
    Fwd_selmu_mom_P0Dveto_3->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_P0Dveto.png");


////  // -------------------------------------------------
////  // Fwd: selmu_mom for tracks with P0DECal veto
////  // -------------------------------------------------
////  TCanvas *Fwd_selmu_mom_P0DECalveto_0 = new TCanvas("Fwd_selmu_mom_P0DECalveto_0","Canvas",npix_x,npix_y);
////    gStyle->SetOptStat(0);
////    gStyle->SetTitleOffset(1.3,"Y");
////    draw.SetLegendParam(0.72,0.90,0.90,0.91);
////    draw.SetTitleX("reconstructed momentum [MeV/c]");
...
////    draw.SetLogY(0);
////    draw.Draw(exp,"selmu_mom",100,0,3000,"reactionCC","accum_level[0][0]>11","E1","POTNORM",-1,true);
////    Fwd_selmu_mom_P0DECalveto_0->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_before_P0DECalveto.png");

////  TCanvas *Fwd_selmu_mom_P0DECalveto_1 = new TCanvas("Fwd_selmu_mom_P0DECalveto_1","Canvas",npix_x,npix_y);
////    gStyle->SetOptStat(0);
////    gStyle->SetTitleOffset(1.3,"Y");
////    draw.SetLegendParam(0.72,0.90,0.90,0.91);
////    draw.SetTitleX("reconstructed momentum [MeV/c]");
...
////    draw.SetMinY(0);
////    draw.SetLogY(0);
////    draw.Draw(exp,"selmu_mom",100,0,3000,"reactionCC","accum_level[0][0]>12","E1","POTNORM",-1,true);
////    Fwd_selmu_mom_P0DECalveto_1->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_after_P0DECalveto.png");

////  TCanvas *Fwd_selmu_mom_P0DECalveto_2 = new TCanvas("Fwd_selmu_mom_P0DECalveto_2","Canvas",npix_x,npix_y);
////    gStyle->SetOptStat(0);
////    gStyle->SetTitleOffset(1.3,"Y");
////    draw.SetLegendParam(0.72,0.90,0.90,0.91);
////    draw.SetTitleX("reconstructed momentum [MeV/c]");
...
////    draw.SetLogY(0);
////    draw.Draw(exp,"selmu_mom",100,0,3000,"reactionCC","accum_level[0][0]==12","E1","POTNORM",-1,true);
////    Fwd_selmu_mom_P0DECalveto_2->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_selmu_mom_failed_P0DECalveto.png");

////  TCanvas *Fwd_selmu_mom_P0DECalveto_3 = new TCanvas("Fwd_selmu_mom_P0DECalveto_3","Canvas",npix_x,npix_y);
////    gStyle->SetOptStat(0);
////    gStyle->SetTitleOffset(1.3,"Y");
////    draw.SetLegendParam(0.72,0.90,0.90,0.91);
////    draw.SetTitleX("P0DECal veto [-]");
////    draw.SetTitleY("#events");
////    draw.SetMinY(0);
////    draw.SetLogY(0);
////    draw.Draw(exp,"!cut12[0][0]",2,-0.5,1.5,"reactionCC","accum_level[0][0]>11","E1","POTNORM",-1,true);
////    draw.DrawCutLineVertical(0.5,true,"l");
////    Fwd_selmu_mom_P0DECalveto_3->SaveAs("/home/rberner/nd280work/antiNumuCCInc4PiAnalysis/Plots/CutValues/PNGs/Fwd/Fwd_P0DECalveto.png");
