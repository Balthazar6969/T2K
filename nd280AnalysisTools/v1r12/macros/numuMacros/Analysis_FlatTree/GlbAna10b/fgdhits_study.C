...
void fgdhits_study(int mode=-1){
    ...
    if(mode == -2 || mode == 1){
        ...
        // MC: CCQE CUTS
        true_cut[0]="BunchNbr==0 && ("+cuts.fgdFV_cutMC2[0]+") && sTrueReacCode==1 &&  sTrueNuPDG==14 ";
        seltrue_cut[0]="trTrueVertexIndex[0]>-1 && "+cuts.fgdFV_cutMC[0]+" && sTrueReacCode[trTrueVertexIndex[0]]==1 &&  sTrueNuPDG[trTrueVertexIndex[0]]==14";
        ...
        //2) use unused cut
        cuts.reset();
        cuts.scutin[0][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8))";
        cuts.scutin[1][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8))";
        cuts.DoCumulativeCut();
        for(int icut=0;icut<ncuts;icut++){
            sel_cut[icut]="("+cuts.scut[0][icut]+")";
            true_cut[icut]=true_cut[0];
        ...
        cuts.reset();
        cuts.scutin[0][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) && NFgdTracksBunch<2";
        cuts.scutin[1][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) && NFgdTracksBunch<2";
        cuts.DoCumulativeCut();
        for(int icut=0;icut<ncuts;icut++){
            sel_cut[icut]="("+cuts.scut[0][icut]+")";
            true_cut[icut]=true_cut[0];
        ...
        cuts.reset();
        cuts.scutin[0][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) && NFgdTracksBunch==0";
        cuts.scutin[1][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) && NFgdTracksBunch==0";
        cuts.DoCumulativeCut();
        for(int icut=0;icut<ncuts;icut++){
            sel_cut[icut]="("+cuts.scut[0][icut]+")";
            true_cut[icut]=true_cut[0];
        ...
        cuts.reset();
        cuts.scutin[0][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) && Alt$(trFgdNHits[0],0)+Alt$(trFgdNHits[1],0)+Alt$(trFgdNHits[2],0)+Alt$(trFgdNHits[3],0)<25";
        cuts.scutin[1][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8)) &&Alt$(trFgdNHits[0],0)+Alt$(trFgdNHits[1],0)+Alt$(trFgdNHits[2],0)+Alt$(trFgdNHits[3],0)<25";
        cuts.DoCumulativeCut();
        for(int icut=0;icut<ncuts;icut++){
            sel_cut[icut]="("+cuts.scut[0][icut]+")";
            true_cut[icut]=true_cut[0];
    ...
    if(mode == -2 || mode == 2){
        ...
        s_acut_b[0]=basic+" && "+cuts.fgd1FV_cut[0]+" && Alt$(trFgdDet[0],0)==4 ";
        s_acut_c[0]=basic+" && "+cuts.fgd1FV_cut[0]+" && Alt$(trFgdDet[1],0)==4 ";
        s_acut_d[0]=basic+" && "+cuts.fgd1FV_cut[0]+" && Alt$(trFgdDet,0)==4 ";
        
        s_var_a[0]="sNFGDUnusedHits[0]";
        s_var_b[0]="trFgdNHits[0]";
        s_var_c[0]="trFgdNHits[1]";
        s_var_d[0]="Alt$(trFgdNHits[0],0)+Alt$(trFgdNHits[1],0)+Alt$(trFgdNHits[2],0)+Alt$(trFgdNHits[3],0)";
        s_var_e[0]="NFgdTracksBunch";
...
//         comp.draw_var(NCUTS-1,s_var_c," N hits of fgd1 trk2 when rec vtx is in FGD1 ",100, 0,100,-1,s_acut_c,1);
        ...
        s_acut_b[0]=basic+" && "+cuts.fgd2FV_cut[0]+" && Alt$(trFgdDet[0],0)==5 ";
        s_acut_c[0]=basic+" && "+cuts.fgd2FV_cut[0]+" && Alt$(trFgdDet[1],0)==5 ";
        s_acut_d[0]=basic+" && "+cuts.fgd2FV_cut[0]+" && trFgdDet==5";
    
        s_var_a[0]="sNFGDUnusedHits[1]";
...
//        comp.draw_var(NCUTS-1,s_var_c," N hits of fgd2 trk2 when rec vtx is in FGD2 ",100, 0,100,-1,s_acut_c,1);
    ...
    if(mode==-2 || mode==3){
      //do not compare with data
        ...
        s_acut_a[0]=basic;
        s_var_a[0]="ENuRec[0]";//"trENuRec_1Muon";

        comp._cuts->reset();
        comp._cuts->scutin[0][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8))";
        comp._cuts->scutin[1][10]="( ("+ cuts.fgd1FV_cut[0]+" && sNFGDUnusedHits[0]<15 ) || ("+cuts.fgd2FV_cut[0]+" && sNFGDUnusedHits[1]<8))";
        comp._cuts->DoCumulativeCut();
