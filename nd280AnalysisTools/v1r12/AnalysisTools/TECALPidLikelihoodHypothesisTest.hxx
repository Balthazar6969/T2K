 ...
 * //for each particle type/topology classification and each PID variable you
 * must
 * //provide a pdf. eg
 * likelihoodCalc.AddPdf(TECALPidDefs::kECALPidHypothesis_EMShower, histogram,
 * TECALPidDefs::kECALPidVar_AMR);
 *
 * //in the event loop
 ...
 * //get the result
 * double llr =
 * likelihoodCalc.GetLogLikelihoodRatio(TECALPidDefs::kECALPidHypothesis_EMShower,TECALPidDefs::kECALPidHypothesis_HadronicShower);
 * @endcode
 *
...
public:
   ...
   *  @param[in] name needs the name of the algorithm to make object names
   * unique.
   */
   ...
   *
   */
  void AddPdf(Hypothesis hypothesis, TH2F *hist, Variable variable,
   ...
   *
   */
  void AddPdf(Hypothesis hypothesis, TTree *tree, Variable variable,
   ...
   *
   *  @param[in] hypothesis specifies the hypothesis.
   *  @param[in] truncateValue specifies a limit to prevent taking the log of
   *zero.
   ...
   *  @see TECALPidLikelihoodHypothesis::GetLogLikelihood
   */
  double GetLogLikelihoodRatio(Hypothesis hypothesis1, Hypothesis hypothesis2,
                               double truncateValue = 1E9);
  ...
  typedef std::runtime_error
      BadHypothesisException; // TODO, implement exceptions.
...
/** @brief Calculates log likelihood ratios used by
 * TECALPidLikelihoodHypothesisTest
 *
...
{
public:
  typedef std::runtime_error BadVariableException; // TODO, implement
                                                   // exceptions.
   ...
   *  @param[in] hypothesis
   */
  TECALPidLikelihoodHypothesis(std::string algorithmName,
