#ifndef TNUANCEAnalysisUtils_h_seen
#define TNUANCEAnalysisUtils_h_seen
...
/// which helps understand NUANCE neutrino generator output
///
/// This can be queried to ask if particular interactions were CC or
/// not, for example.
class TNUANCEAnalysisUtils : public TVNeutrinoGeneratorAnalysisUtils {

public:
  TNUANCEAnalysisUtils(){};

  virtual ~TNUANCEAnalysisUtils(){};
