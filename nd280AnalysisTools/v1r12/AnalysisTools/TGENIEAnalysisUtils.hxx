#ifndef TGENIEAnalysisUtils_h_seen
#define TGENIEAnalysisUtils_h_seen
...
/// which helps understand GENIE neutrino generator output
///
/// This can be queried to ask if particular interactions were CC or
/// not, for example.

class TGENIEAnalysisUtils : public TVNeutrinoGeneratorAnalysisUtils {

public:
  TGENIEAnalysisUtils(TClonesArray *vertices, Int_t *n_vertices)
      : fRooVtx(vertices), fNRooVtx(n_vertices){};

  TGENIEAnalysisUtils() : fRooVtx(0), fNRooVtx(0){};
  ...
  ND::GRooTrackerVtx *GetVertexById(Int_t id) const;

  virtual ~TGENIEAnalysisUtils(){};
