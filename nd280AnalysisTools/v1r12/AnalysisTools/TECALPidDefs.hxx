...
class EECALPidDefException : public std::exception {
  virtual const char *what() const throw() { return "EECALPidDefException"; }
};

class EECALPidDefUnknownId : public EECALPidDefException {
  virtual const char *what() const throw() { return "EECALPidDefUnknownId"; }
};

class EECALPidDefUnknownName : public EECALPidDefException {
  virtual const char *what() const throw() { return "EECALPidDefUnknownName"; }
};
 ...
 *  variables and hypotheses (i.e. particle type/object topology
 * classifications)
