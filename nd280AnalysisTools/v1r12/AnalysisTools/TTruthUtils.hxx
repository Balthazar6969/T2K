...
public:
  ...
  /// methods provided
  TTruthUtils(TClonesArray *trajectories, TClonesArray *vertices,
  ...
  static bool
  EnteredSubdetector(ND::TTruthTrajectoriesModule::TTruthTrajectory *traj,
                     oaAnalysisEnums::ESubdetector SubDet);
  static bool
  ExitedSubdetector(ND::TTruthTrajectoriesModule::TTruthTrajectory *traj,
                    oaAnalysisEnums::ESubdetector SubDet);

  static TLorentzVector
  EntrancePosition(ND::TTruthTrajectoriesModule::TTruthTrajectory *traj,
                   oaAnalysisEnums::ESubdetector SubDet);
  static TLorentzVector
  ExitPosition(ND::TTruthTrajectoriesModule::TTruthTrajectory *traj,
               oaAnalysisEnums::ESubdetector SubDet);
  ...
  GetTrajectoryById(Int_t id) const;

  /// Get the first parent of a trajectory.
  /// If the trajectory has no parent, return NULL (ie: it is a primary
  /// trajectory). If the parent is not stored, return NULL.
  ND::TTruthTrajectoriesModule::TTruthTrajectory *
  GetParentTrajectory(Int_t child_id) const;
  ND::TTruthTrajectoriesModule::TTruthTrajectory *GetParentTrajectory(
      ND::TTruthTrajectoriesModule::TTruthTrajectory *child_trajectory) const;

  /// Get the primary parent of a trajectory.
  /// If the trajectory has no primary parent, return NULL
  ///(ie: it is a primary trajectory).
  /// If the primary parent is not stored, return NULL
  ///(the primary trajectories are always stored)
  ND::TTruthTrajectoriesModule::TTruthTrajectory *
  GetPrimaryParentTrajectory(Int_t child_id) const;
  ND::TTruthTrajectoriesModule::TTruthTrajectory *GetPrimaryParentTrajectory(
      ND::TTruthTrajectoriesModule::TTruthTrajectory *child_trajectory) const;

  /// Get trajectories sorted by momentum.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetMomentumSortedTrajectories() const;

  /// Get trajectories of a specific particle category.
  /// The integer values specifying the particle type are defined
  /// in oaAnalysis oaAnalysisEnums::EParticleCategory.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByCategory(oaAnalysisEnums::EParticleCategory category) const;

  /// Get trajectories by final detector.
  /// The integer values specifying the detector are defined in
  /// oaAnalysis oaAnalysisEnums::ESubdetector.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByFinalSubdetector(
  ...
  /// oaAnalysis oaAnalysisEnums::ESubdetector.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByInitSubdetector(
  ...
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByName(std::string name) const;

  /// Get all trajectories with a specific PDG code
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByPDG(Int_t pdg) const;

  /// Get trajectories with a specific parent.
  /// This will not include the parent itself.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByParent(Int_t parent_id) const;
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByParent(
  ...
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByPrimaryParent(Int_t primary_parent_id) const;
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesByPrimaryParent(
  ...
  /// oaAnalysis oaAnalysisEnums::ESubdetector.
  std::vector<ND::TTruthTrajectoriesModule::TTruthTrajectory *>
  GetTrajectoriesBySubdetector(oaAnalysisEnums::ESubdetector subdetector) const;
  ...
  GetVertexOfTrajectory(Int_t trajectory_id) const;
  ND::TTruthVerticesModule::TTruthVertex *GetVertexOfTrajectory(
  ...
  /// If vertex is not stored, return NULL.
  ND::TTruthVerticesModule::TTruthVertex *
  GetVertexOfPrimaryTrajectory(Int_t primary_trajectory_id) const;
  ND::TTruthVerticesModule::TTruthVertex *GetVertexOfPrimaryTrajectory(
