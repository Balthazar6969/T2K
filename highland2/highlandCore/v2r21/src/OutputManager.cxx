...
//********************************************************************
  ...
  _tree_vars_exist_float.resize(NMAXTREES);
  _tree_vars_exist_double.resize(NMAXTREES);
  _tree_vars_exist_int.resize(NMAXTREES);
  _tree_vars_exist_char.resize(NMAXTREES);

  _tree_vars_exist_float_vector.resize(NMAXTREES);
  _tree_vars_exist_double_vector.resize(NMAXTREES);
  _tree_vars_exist_int_vector.resize(NMAXTREES);
  _tree_vars_exist_char_vector.resize(NMAXTREES);

  _tree_vars_exist_float_matrix.resize(NMAXTREES);
  _tree_vars_exist_double_matrix.resize(NMAXTREES);
  _tree_vars_exist_int_matrix.resize(NMAXTREES);
  _tree_vars_exist_char_matrix.resize(NMAXTREES);

  _tree_vars_exist_float_3Dmatrix.resize(NMAXTREES);
...
//**************************************************
  ...
  _tree_vars_exist_float[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_double[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_int[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_char[tree_index].resize(NMAXTREEVARS);

  _tree_vars_exist_float_vector[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_double_vector[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_int_vector[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_char_vector[tree_index].resize(NMAXTREEVARS);

  _tree_vars_exist_float_matrix[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_double_matrix[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_int_matrix[tree_index].resize(NMAXTREEVARS);
  _tree_vars_exist_char_matrix[tree_index].resize(NMAXTREEVARS);

  _tree_vars_exist_float_3Dmatrix[tree_index].resize(NMAXTREEVARS);
  ...
  for (UInt_t i=0;i<NMAXTREEVARS;i++){
    _tree_vars_exist_float[tree_index][i]=false;
...
//**************************************************
  ...
  return (tree_index < (Int_t)NMAXSPECIALTREES);
}
...
//********************************************************************
  ...
  for (cit= GetTrees().begin();cit!=GetTrees().end();cit++){    
    ...
    std::string counter_name = _tree_vars_vector_counter[_current_tree][name];
...
//********************************************************************  
  ...
  if (type=="I"){
    ...
    _tree_vars_exist_int[tree_index][index]=true;
    ...
    _tree_vars_exist_float[tree_index][index]=true;
    ...
    _tree_vars_exist_double[tree_index][index]=true;
    ...
    _tree_vars_exist_char[tree_index][index]=true;
...
//********************************************************************
  ...
  _tree_vars_exist_int[tree_index][counter_index]=true;
...
//********************************************************************
  ...
  if (indx1==-1)
    indx1 = _tree_vars_counter[_current_tree][counter_index];
...
//********************************************************************
  ...
  if (!_tree_vars_exist_double[_current_tree][index]) WrongVariableType(index, "","Double");
  _tree_vars_double[_current_tree][index]= var;
}
...
//********************************************************************
  ...
  if (!_tree_vars_exist_int[_current_tree][index])  WrongVariableType(index, "","Int");
  _tree_vars_int[_current_tree][index]= var;
}
...
//********************************************************************
  ...
  if (!_tree_vars_exist_char[_current_tree][index])  WrongVariableType(index, "","Char");
  _tree_vars_char[_current_tree][index].Fill(var);
}
...
//********************************************************************
  ...
  return _tree_vars_double[_current_tree][index];
}
...
//********************************************************************
  ...
  return _tree_vars_int[_current_tree][index];
}
