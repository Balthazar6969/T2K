...
#
#   Generated Mon Nov  4 15:26:48 2019  by cfrancois
#
#====================================
...
$(highlandUtilslib) :: $(bin)CategToolsNueCC.o $(bin)CategoriesUtils.o $(bin)HighlandAnalysisUtils.o $(bin)HighlandConstituentsUtils.o $(bin)HighlandPIDUtils.o $(bin)HighlandTreeConverterUtils.o $(bin)IntersectionUtils.o $(bin)ND280GeomId.o $(bin)P0DAnalysisUtils.o $(bin)P0DGeometryManager.o $(bin)ProductionUtils.o $(bin)RooTrackerVtxManager.o $(bin)TECALPidDefs.o $(bin)TECALPidLikelihood.o $(bin)TECALPidLikelihoodHypothesisTest.o $(bin)TTruthUtils.o $(bin)BitUtils.o $(bin)ControlPanel.o $(bin)DetectorForager.o $(bin)EventPlotter.o $(bin)EventReader.o $(bin)ControlPanel_Dict.o
...
highlandUtilsclean ::
	...
	$(cleanup_silent) /bin/rm -f $(bin)CategToolsNueCC.o $(bin)CategoriesUtils.o $(bin)HighlandAnalysisUtils.o $(bin)HighlandConstituentsUtils.o $(bin)HighlandPIDUtils.o $(bin)HighlandTreeConverterUtils.o $(bin)IntersectionUtils.o $(bin)ND280GeomId.o $(bin)P0DAnalysisUtils.o $(bin)P0DGeometryManager.o $(bin)ProductionUtils.o $(bin)RooTrackerVtxManager.o $(bin)TECALPidDefs.o $(bin)TECALPidLikelihood.o $(bin)TECALPidLikelihoodHypothesisTest.o $(bin)TTruthUtils.o $(bin)BitUtils.o $(bin)ControlPanel.o $(bin)DetectorForager.o $(bin)EventPlotter.o $(bin)EventReader.o $(bin)ControlPanel_Dict.o
