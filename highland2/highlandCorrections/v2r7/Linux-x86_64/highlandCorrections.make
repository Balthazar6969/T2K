...
#
#   Generated Mon Nov  4 15:26:56 2019  by cfrancois
#
#====================================
...
ifndef QUICK
$(bin)highlandCorrections_dependencies.make : ../src/CT4POTCorrection.cxx ../src/DataQualityCorrection.cxx ../src/FlipKinematicsCorrection.cxx ../src/IgnoreRightECalRuns3and4Correction.cxx ../src/MomRangeCorrection.cxx ../src/MomResolMCCorrection.cxx ../src/PileUpCorrection.cxx ../src/TPCExpecteddEdxCorrection.cxx ../src/TPCPIDPullMCCorrection.cxx ../src/TPCdEdxDataCorrection.cxx ../src/TPCdEdxMCCorrection.cxx ../src/ToFCorrection.cxx ../src/UseGlobalAltMomCorrection.cxx $(use_requirements) $(cmt_final_setup_highlandCorrections)
	$(echo) "(highlandCorrections.make) Rebuilding $@"; \
	  $(build_dependencies) highlandCorrections -all_sources -out=$@ ../src/CT4POTCorrection.cxx ../src/DataQualityCorrection.cxx ../src/FlipKinematicsCorrection.cxx ../src/IgnoreRightECalRuns3and4Correction.cxx ../src/MomRangeCorrection.cxx ../src/MomResolMCCorrection.cxx ../src/PileUpCorrection.cxx ../src/TPCExpecteddEdxCorrection.cxx ../src/TPCPIDPullMCCorrection.cxx ../src/TPCdEdxDataCorrection.cxx ../src/TPCdEdxMCCorrection.cxx ../src/ToFCorrection.cxx ../src/UseGlobalAltMomCorrection.cxx
endif
...
$(bin)highlandCorrections_dependencies.make : $(PileUpCorrection_cxx_dependencies)

$(bin)$(binobj)PileUpCorrection.o : $(PileUpCorrection_cxx_dependencies)
	$(cpp_echo) $(src)PileUpCorrection.cxx
	$(cpp_silent) $(cppcomp) -o $(@) $(use_pp_cppflags) $(highlandCorrections_pp_cppflags) $(lib_highlandCorrections_pp_cppflags) $(PileUpCorrection_pp_cppflags) $(use_cppflags) $(highlandCorrections_cppflags) $(lib_highlandCorrections_cppflags) $(PileUpCorrection_cppflags) $(PileUpCorrection_cxx_cppflags)  $(src)PileUpCorrection.cxx
